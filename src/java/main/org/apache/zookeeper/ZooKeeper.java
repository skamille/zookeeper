...
/**
     ...
     * @see Op
     * @see ZooKeeper#multi(Iterable, java.util.List)
    ...
    /**
     * Executes multiple Zookeeper operations or none of them and maintains a list of results.  On success,
     * a list of results is returned and is also inserted into the results argument.
     * On failure, only a single exception is returned, but the contents of results is updated to contain
     * information on each operation which could indicate success, failure or that the operation was not tried
     * because an earlier operation failed.
     * @param ops  An iterable that contains the operations to be done.  These should be created using the
     * factory methods on Op.
     * @param results A list that is filled in with result structures, one for each op given in ops.
     * @see Op
